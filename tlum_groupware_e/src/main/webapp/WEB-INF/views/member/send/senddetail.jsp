		...
		<div class="aside">
			<div>
				<form role="form" action="update" method="POST">
					<input type="text" name="msg_title" value="${msgSend.msg_title}"/>
					<input type="text" name="msg_content" value="${msgSend.msg_content}"/>
						
					<input type="hidden" name="receive_id" value="${msgSend.receive_id }"/><br/>
					<input type="text" name="receive_name" value="${msgSend.receive_name }"/><br/>
					<input type="text" name="emp_name" value="${msgSend.emp_id }"/><br/>
