         ...
         <div class='box-body'>
            ...
            <table class="table table-striped table-hover">
               ...
               <c:forEach items="${appList}" var="app">
                  <tr>
                     <td>
                        <a href="detail?app_no=${app.app_no }">${app.app_no }</a>
                     </td>
                     <td>
                        <a href="detail?app_no=${app.app_no }">${app.app_title }</a>
                     </td>
                     
                     <td>
                        <a href="detail?app_no=${app_no}">${app.emp_id }</a>
                     </td>
                     
                  </tr>
               </c:forEach>
            </table>
            <button id='newBtn' class="btn btn-primary" onclick="javascript:location.href='insert';">부서등록</button>
         </div>
      </div>
