...
<form role="form" method="post">
		<h1>LIMIT 게시판 작성</h1>			
			<br/>번호<input type="text" name="limit_board_bno"/>
			
			<!-- <br/>내용<input type="text" name="limit_board_content"/> -->
			작성자<input type="text" name="emp_id"/>
			부서<input type="text" name="grade_no"/>
			<br/>제목<input type="text" name="limit_board_title"/>
			<!-- 스마트 에디터 본문 -->
